        ...
        <div class="page-content-wrapper-inner">
          <div class="content-viewport">
                ...
                <div class="col-md-12 equel-grid">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr>
                                <td class="pr-0 pl-4">
                                    <img class="profile-img img-sm" src="{{ asset('assets/images/profile/male/image_4.png') }}" alt="profile image">
                                </td>
                                <td class="pl-md-0">
            ...
            <div class="row">
              <div class="col-12 py-5">
                <h3>Extensão</h3>
                <p class="text-gray">Atividades de extensão praticadas fora do âmbito do curso ou da comunidade da UFFS.</p>
                <hr />
              </div>
            </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-sm">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('assets/images/profile/male/image_3.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('assets/images/profile/female/image_2.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
                        ...
                        <tr>
                          <td class="pr-0 pl-4">
                            <img class="profile-img img-sm" src="{{ asset('assets/images/profile/male/image_10.png') }}" alt="profile image">
                          </td>
                          <td class="pl-md-0">
